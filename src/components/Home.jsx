...
function Home() {
    ...
    //         // let response = await axios.get('data.sec.gov/submissions/')
    //         // let data = response.data
    //         // console.log(data)
    //         // let response = await axios.get('https://financialmodelingprep.com/api/v3/cik-search/Berkshire?apikey=YNrEbeq5E60bBHbB2eDgmlCGieUQDYKe')
    //         // let data = response.data
    //         // console.log(data)
    //     }
